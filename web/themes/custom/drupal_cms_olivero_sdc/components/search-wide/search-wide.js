...
((Drupal, $) => {
  ...
  Drupal.drupal_cms_olivero_sdc = Drupal.drupal_cms_olivero_sdc || {};
  Drupal.drupal_cms_olivero_sdc.searchIsVisible = searchIsVisible;
  ...
  Drupal.drupal_cms_olivero_sdc.toggleSearchVisibility = toggleSearchVisibility;
